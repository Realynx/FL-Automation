; FruityLink version.dll proxy — export forwarders (x64, MASM/ml64).
; Each real version.dll export is re-exported here as a tiny stub that jmps through
; g_FunctionTable[i], which the C DllMain populates with the genuine
; C:\Windows\System32\version.dll proc addresses. Index order MUST match
; PopulateFunctionTable() in dllmain.c.
;
; Pattern lifted verbatim from RealLoader/Bootstrapping/VersionProxyDll (the product
; owner's own prior project) — proven transparent forwarding for version.dll.
