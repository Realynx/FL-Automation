#pragma once
// Tell the linker to export each forwarder stub (defined in versionASMStubs.asm) under
// the real version.dll export name. FLEngine_x64.dll imports these from "version.dll"; with
// our proxy in the FL dir (non-KnownDLL, app-dir-first), it binds to these stubs instead.
